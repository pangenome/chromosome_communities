...
for e in 50000 ; do
  for m in 1000 ; do
    ...
    path_entropy_by_contig_tsv=/lizardfs/guarracino/chromosome_communities/untangle/grounded/entropy/$prefix.untangle.chm13#chrACRO.e$e.m$m.grounded.pq_touching.reliable.entropy.by_contig.tsv
    if [[ ! -s ${path_entropy_by_contig_tsv} ]]; then
      python3 /lizardfs/guarracino/chromosome_communities/scripts/entropy.by_contig.py $path_grounded_pq_touching_reliable_all_chromosomes_tsv_gz chm13#ACRO.len.tsv 1 1 > $path_entropy_by_contig_tsv
    fi
