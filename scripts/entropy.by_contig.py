...
print('\t'.join(['grounded.target', 'start.pos', 'end.pos', 'contig', 'shannon_div_index']))
for grounded_target, group_2_query_2_pieces_dict in ground_2_group_2_query_2_pieces_dict.items():
    ...
    for group, query_2_pieces_dict in group_2_query_2_pieces_dict.items():
        ...
        for query, pieces_list in query_2_pieces_dict.items():
            ...
            query_on_ref_list = [0] * grounded_target_len
            ...
            for start in range(0, len(query_on_ref_list), window_size):
                ...
                print('\t'.join([grounded_target, str(start), str(end), query, str(shannon_div_index)]))
