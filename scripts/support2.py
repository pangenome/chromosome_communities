...
with gzip.open(path_support_tsv_gz, "rt") as f:
    ...
    for line in f:
        ...
        current_end = end
        current_line = '_'.join(
            [ground_target, num_contigs_supporting_chr13, num_contigs_supporting_chr14, num_contigs_supporting_chr15,
        ...
        if last_line == '':
            ...
            ground_target_x, num_contigs_supporting_chr13_x, num_contigs_supporting_chr14_x, num_contigs_supporting_chr15_x, num_contigs_supporting_chr21_x, num_contigs_supporting_chr22_x = last_line.split(
                '_')
            print(
                '\t'.join([str(x) for x in [
